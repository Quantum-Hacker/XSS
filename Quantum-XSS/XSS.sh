...
usage(){
    printf "XSS Usage:\n\n"
    printf "./XSS -d <target.com>\n"
    printf "./XSS -d <target.com> -b <blindxss.xss.ht>\n"
    printf "./XSS -d <target.com> -o xss_results.txt \n"
    printf "./XSS -d <target.com> -b <blindxss.xss.ht> -o xss_results.txt\n\n"
    exit 1;
}
...
while [ -n "$1" ]; do
        ...
        -o| --output)
            ...
            ;;
                -v|--version)
                        echo "Version of Quantum-XSS: $version"
                        exit 0 ;;
                *)
